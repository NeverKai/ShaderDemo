...
tf5.x = vec4(__LightColorInt).x;
tf5.y = vec4(__LightColorInt).y;
tf5.z = vec4(__LightColorInt).z;
...
tf2.x = vec4(__MainTexInvisible).x;
tf2.y = vec4(__MainTexInvisible).y;
tf2.z = vec4(__MainTexInvisible).z;
